...
describe('Signal transaction seal exact catalog contract', () => {
  it('accepts exactly twenty-one reviewed functions, fifty-four guards and four xid8 columns', () => {
    const fixture = signalImmutabilityFixture();
    expect(fixture.routines).toHaveLength(21);
    expect(fixture.triggers).toHaveLength(54);
