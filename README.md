...
- [ ] Deliver FTS-1 separately: migrate and persist the canonical projection, configure PostgreSQL FTS, backfill, prove query parity and only then cut production search over
