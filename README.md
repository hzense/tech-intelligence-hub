...
- [ ] Finish the target-database ACL and protected credential setup, then configure, redeploy and independently verify the Production-only Vercel integration
