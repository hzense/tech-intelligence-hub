...
**状态：** 目标设计分批实施中；V2-1a 数据快照、任职证据与事件身份已合并，正在交付事务封存与受限写入，生产权威与权限未切换
