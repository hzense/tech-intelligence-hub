...
10. 🚧 进行中：已完成新七天回滚分支、Runtime read-only 默认值、`neondb` 隔离、Migrator 容量治理、目标 ACL 有界只读复核与 PR #36 健康门禁；独立 Runtime 凭据、保留库深检、Vercel Production 注入、Runtime-configured 重部署及健康/读取/日志验收仍待完成。
