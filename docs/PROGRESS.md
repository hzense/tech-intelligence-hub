...
**最后更新：** 2026-09-13
**当前阶段：** 旧网站 MVP 已交付；Signal-first v2 私有资格发表核心、候选核验及受限公开发布／撤回已合并；Google 管理员认证已上线；AI 连接与分阶段模型配置已完成本地开发和隔离验证，通过独立 PR 交付，评审／CI／合并另行确认，未配置生产 AI 密钥；生产数据库及网站尚未切换新版
