...
核心实体：People、Companies、Institutions、Technologies、Products、Research / Papers。所有实体与 Topic、Signal、Insight 双向关联。
...
关系模型示例：Person → works_at → Company；Company → develops → Technology；Technology → related_to → Topic；Paper → researches → Technology；Signal → affects → Topic；Insight → supported_by → Signal。

## 15. Timeline

Topic、Company、Technology、Person 和 Product 支持时间线，并逐步从 Signals 自动生成。

## 16. Search / Ask HZense

全文搜索覆盖 Topic、Insight、Signal、Company、Person、Institution、Paper、Technology。Ask HZense 后续基于 Hybrid Retrieval + RAG 回答，并提供来源引用。
...
- [ ] Topics
- [ ] Signals
- [ ] People / Companies / Institutions / Papers
